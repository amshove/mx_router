...
(Der Name der .conf-Datei ist egal - den kann man selbst waehlen)
...
- Nun ist der Router fertig konfiguriert und kann verwendet werden.
Dazu loggt man man sich auf der Webseite ein:
http://<ip des routers>/
User: admin
PW: mx_router
